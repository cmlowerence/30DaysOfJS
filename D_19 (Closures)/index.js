...

{
  ...
  {
    const Q_1 =
      "Create a personAccount out function, It has firstName, lastName, incomes, expenses inner variables. It has totalIncome, totalExpense, accountInfo, addIncome, addExpense and accountBalance inner functions. Incomes is a set of incomes and its description and expense is also a set of expenses and its description.";

    console.log(
      "%cindex.js line:107 Q_1",
      "color: white; background-color: #007acc;",
      Q_1
    );
    {
...

      {
        function khumesh(firstName = "Default", lastName = "Default") {
          ...
          return {
            ...
            addIncome: (income) => {
              Object.assign(incomes, income);
              totalIncome = calcTotal(incomes);
            },
            addExpense: (expense) => {
              Object.assign(expenses, expense);
              totalExpense = calcTotal(expenses);
            },
          };
        }
